...
<body>
    ...
    class PersonaDAO
    {
        ...
        public function registrar($persona)
        {
            ...
            " . $persona->getIdRol() . ")";
            $resultado = mysqli_query($link, $sql)  or die(alertaError("Error al insertar Persona ", mysqli_error($link)));
            alertaCorrecto("Persona Registrada correctamente");
        }
    ...
    class MedicoDAO
    {
        ...
        public function insertarIdPersona($idPersona)
        {
            ...
            " . $idPersona . ")";
            $resultado = mysqli_query($link, $sql)  or die("Error al insertar id en tabla medico");
        }
    }
    ...
    class Empleado
    {
        ...
        public function setIdPersona($idEmpleado)
        {
    ...
    class EmpleadoDAO
    {
        ...
        public function insertarIdPersona($idPersona)
        {
            $conexion = new Conexion();
            $link = $conexion->conectar();
            $sql = "INSERT INTO empleado (idPersona) VALUES (
            " . $idPersona . ")";
